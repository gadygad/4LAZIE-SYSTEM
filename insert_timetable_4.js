...
<div class="timetable-bw" style="background: white; padding: 20px; border-radius: 5px;">
    ...
    <div class="doc-header">
        ...
        <h3>FOURTH YEAR (BATCH 17) SEMESTER II - DEGREE TIMETABLE APRIL 2026</h3>
        ...
        <div style="display: flex; justify-content: space-between; font-weight: bold; margin-top: 15px; font-size: 14px;">
            ...
            <div>STRENGHT: 142</div>
            <div>LECTURE HALL: 94</div>
        </div>
    </div>
    ...
    <table>
        ...
        <tr>
            <td>MONDAY</td>
            <td colspan="3">ELCE0004</td>
            <td colspan="2">TS4210</td>
            <td colspan="2">TS4210</td>
        </tr>
        <tr>
            <td>TUESDAY</td>
            <td colspan="3">MG4207</td>
            <td colspan="2">ELCE0004</td>
            <td colspan="2">ELCE00014</td>
        </tr>
        <tr>
            <td>WEDNESDAY</td>
            <td colspan="3">ELCE00014</td>
            <td colspan="2">MG4207</td>
            <td colspan="2">051PJ89</td>
        </tr>
        <tr>
            <td>THURSDAY</td>
            <td colspan="3">TS4210</td>
            <td colspan="2">051PJ89</td>
            <td colspan="2">051PJ90</td>
        </tr>
        <tr>
            <td>FRIDAY</td>
            <td colspan="3">051PJ89</td>
            <td colspan="2">TS4210</td>
            <td colspan="2">051PJ89</td>
        </tr>
    </table>
    ...
    <table style="margin-top: 20px; text-align: left;">
        ...
        <tr><td>MG4207</td><td>ENTREPRENEURSHIP DEVELOPMENT (T)</td><td>DR SHASHIKANT</td></tr>
        <tr><td>TS4210</td><td>TECHNICAL SEMINAR (P)</td><td>MR. KOMBE</td></tr>
        <tr><td>ELCE0004</td><td>CONSTRUCTION TECHNIQUES, EQUIPMENT & PRACTICE (T)</td><td>DR BULAMILE</td></tr>
        <tr><td>ELCE00014</td><td>BRIDGE ENGINEERING (T)</td><td>MR MWAMBINGU</td></tr>
        <tr><td>PJCE4211</td><td>PROJECT PHASE II (P)</td><td>MR KOMBE</td></tr>
    </table>
    <br>
