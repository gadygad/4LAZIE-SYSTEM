...
public class GlobalSidebarAdvice {
        ...
        private com.school.notification.NotificationRepository notificationRepository;

        private com.school.academic.AcademicCalendarRepository academicCalendarRepository;

        private com.school.notes.NoteRepository noteRepository;

    public GlobalSidebarAdvice(InstitutionRepository institutionRepository, CourseRepository courseRepository, com.school.notification.NotificationRepository notificationRepository, com.school.academic.AcademicCalendarRepository academicCalendarRepository, com.school.notes.NoteRepository noteRepository) {
    ...
    public void addSidebarDataToModel(Model model, jakarta.servlet.http.HttpSession session) {
        ...
        if (user != null && !model.containsAttribute("notifications")) {
            try {
                List<com.school.notification.Notification> notifications = notificationRepository.findByUserIdOrderByCreatedAtDesc(user.getId());
        ...
        try {
            ...
            if (calHolder[0] != null) {
                com.school.academic.AcademicCalendar cal = calHolder[0];
