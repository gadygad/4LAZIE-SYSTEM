...
// Target the exact block of HTML starting with the mortarboard icon and ending at the paragraph end
let searchRegex = /<div class="d-flex align-items-center gap-2 mb-2 justify-content-center justify-content-md-start">[\s\S]*?\(ERB\)<\/strong> of Tanzania\.\s*<\/p>/;

let newHtml = `<div class="d-flex align-items-center gap-2 mb-4 justify-content-center justify-content-md-start">
...
if (c.match(searchRegex)) {
    fs.writeFileSync(file, c.replace(searchRegex, newHtml));
    console.log("Success replacing in home.html");
} else {
    console.log("Target not found in home.html");
}
